        ...
        <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="assets/img/blog1.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="assets/img/blog2.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="assets/img/blog3.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
               ...
               <div class="row border p-4">
                ...
                <div class="col-md-6">
                    <p class="p-4">Satara, a city in Maharashtra, India, is known for its vibrant nightlife. With several nightclubs and bars scattered throughout the city, it can be challenging to decide where to go.
                        <br>
                    Hotels are not just places to sleep; they are places to dream, to plan new adventures, and to create beautiful memories.
                    <br>
                    A great hotel can turn an ordinary trip into an extraordinary one. It's where comfort, luxury, and hospitality meet."</p>
                </div>
               </div>
               ...
               <div class="row border p-4">
                ...
                <div class="col-md-6">
                    <p class="p-4">Yoga is a practice that has been around for centuries and has gained a lot of popularity in recent times. Pune is a city in India that is known for its yoga and wellness centers.
                        <br>
