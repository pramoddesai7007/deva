...
window.addEventListener('scroll', function() {
    ...
    <link rel="icon"   <img src="<?php echo base_url();?>assets/img/editlogo.png"> 
</head>
...
<body>
        ...
        <li data-target="#carouselExampleIndicators1" data-slide-to="2"></li>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="assets/img/near2.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="assets/img//near1new.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="assets/img/near7.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
    ...
    <section >
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 near-place1 mt-3">
                    <figure class="d-flex flex-column">
                        <img src="assets/img/near1.jpg" class="img-fluid" alt="...">
                        <figcaption>
                            <h4 class="mt-2">Ajinkyatara Fort</h4>
                            <p class="akash" >Ajinkyatara is a fort on one of the seven mountains surrounding the city of Satara in the
                                Sahayadri Mountains of Maharashtra, India. It is a 16th-century fort that was called
                                "Ajimtara" during Aurangzeb regime and was based on Aurangzeb son's name, Ajim. Maharani
                                tarabai capturev and rena Ajinkyatarame.Ajinkyatara is a fort located around 4.0 km from
                                Our Hotel."
                ...
                <div class="col-lg-4 near-place2 mt-3">
                    <figure class="d-flex flex-column">
                        <img src="assets/img/near2.jpg" class="img-fluid" alt="...">
                        <figcaption>
                            <h4 class="mt-2">Kaas Plateau</h4>
                            <p>Kaas plateau is a plateau located around 25 km from Our Hotel.Kaas Plateau has more than
                                150 or more types of flowers, shrubs and grasses. There are two ways to reach Kaas. one
                                the more direct way from Satara and another from Tapola via the link road connecting
                                Mahabaleshwar and Panchgani to Kas Pathar. Kas plateau is 25 km away from Northern part
                                of Koyana Sanctuary.</p>
                        </figcaption>
                    </figure>
                </div>

                <div class="col-lg-4 near-place3 mt-3">
                    <figure class="d-flex flex-column">
                        <img src="assets/img/near3.png" class="img-fluid" alt="...">
                        <figcaption>
                            <h4 class="mt-2">Sajjangad Fort</h4>
                            <p>Sajjangad fort is possible to reach the top of the fort by vehicle.The Sajjangad fort is
                                located in the mountainous terrain of the Western Ghats.From there one has to climb
                                around two hundred and thirty steps to reach the gate of the fort.You can hire an Cab or
                                bus from a famous area of Satara Rajwada.This beautiful fort is situated at about 16 km
                                from our Hotel.</p>
                        </figcaption>
                    </figure>
                </div>
                ...
                <div class="col-lg-4 near-place1 mt-3">
                    <figure class="d-flex flex-column">
                        <img src="assets/img/near4.jpg" class="img-fluid" alt="...">
                        <figcaption>
                            <h4 class="mt-2">Thoseghar water fall</h4>
                            <p>Thoseghar waterfalls is a scenic spot located near the small village of Thoseghar, 25.6
                                km from Our Hotel, at the edge of the Konkan region, in Western India. There are a
                                series of waterfalls, some of them 15 to 20 metres and one of approx 200 metres in
                                height.Heavy rain falls during that season and because of this the falls have more water
                                and are more spectacular.</p>
                        </figcaption>
                    </figure>
                </div>
                ...
                <div class="col-lg-4 near-place2 mt-3">
                    <figure class="d-flex flex-column">
                        <img src="assets/img/nearnew.png" class="img-fluid" alt="...">
                        <figcaption>
                            <h4 class="mt-2">Mahabaleshwar</h4>
                            <p>Mahabaleshwar is hill station, which is 55 km from our Hotel. It is located on the
                                mountainous Sahyadri range of the Western ghats that run North to south along western
                                coast of India. Mahabaleshwar is a vast plateau measuring 150 km2 (58 sq mi), bound by
                                valleys on all sides. It reaches a height of 1,439 m (4,721 ft) at its highest peak
                                above sea level, known as Wilson/Sunrise Point.</p>
                        </figcaption>
                    </figure>
                </div>
                ...
                <div class="col-lg-4 near-place3 mt-3">
                    <figure class="d-flex flex-column">
                        <img src="assets/img/near6.jpg" class="img-fluid" alt="...">
                        <figcaption>
                            <h4 class="mt-2">Aundh Museum</h4>
                            <p>Shri Bhavani Museum in Aundh, which is 41.2 km from our Hotel. The museum has 500
                                miniature paintings of all major schools - Jaipur, Kangra, Mughal, Punjab, Bijapur,
                                Pahadi and Maratha of the period between 15th and 19th century. Shri Bhavani Museum is
                                probably the only museum in India, which has such a large collection. Built by the Raja
                                of Aundh, late Bhawanrao Pantpratinidhi in 1938.
                ...
                <div class="col-lg-4 near-place1 mt-3">
                    <figure class="d-flex flex-column">
                        <img src="assets/img/near7.jpg" class="img-fluid" alt="...">
                        <figcaption>
                            <h4 class="mt-2">Pune Airport</h4>
                            <p>Pune Airport is located approximately 10 km (6.2 mi) northeast of the historic centre of
                                Pune in the state of Maharashtra, India. The airport is a civil enclave operated by the
                                Airports Authority of India at the western side of Lohagaon Air Force Station of the
                                Indian Air Force. The airport serves both domestic and international flights, especially
                                to West Asia. It is about 116 km away from our hotel.</p>
                        </figcaption>
                    </figure>
                </div>
                ...
                <div class="col-lg-4 near-place2 mt-3">
                    <figure class="d-flex flex-column">
                        <img src="assets/img/near8.jpg" class="img-fluid" alt="...">
                        <figcaption>
                            <h4>Vasota Fort</h4>
                            <p>The fort is situated in the deep forests and valleys of Koyna Wildlife
                                Sanctuary.Chatrapati Shivaji Maharaj incorporated the fort into Swarajya in 1655 during
                                the conquest of Javli. Shivaji renamed the fort "Vyaghragad" (Vyaghra – means tiger),
                                owing to its difficult natural defense.Vasota Fort is surrounded by water on three
                                sides.It is about 39 km away from our hotel.</p>
                        </figcaption>
                    </figure>
                </div>
                ...
                <div class="col-lg-4 near-place3 mt-3">
                    <figure class="d-flex flex-column">
                        <img src="assets/img/near9.jpg" class="img-fluid" alt="...">
                        <figcaption>
                            <h4>Panchgani</h4>
                            <p>Panchgani, called Paachgani (पाचगणी in Marathi), is a hill station and municipal council
                                in Satara district in Maharashtra, India. Panchgani attracts many tourists throughout
                                the year. It is also renowned for many premier residential educational
                                institutions.Panchgani is nestled in the middle of five hills in the Sahyādri mountain
                                ranges.It is about 47 km away from our hotel.</p>
                        </figcaption>
                    </figure>
                </div>
            </div>
    ...
    <section>
        <div>
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3800.7516734913565!2d74.02341377429995!3d17.70918729345679!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc239d69a539c3b%3A0xa99023bfc15dbd3f!2sHotel%20Sky%20Inn!5e0!3m2!1sen!2sin!4v1698291177562!5m2!1sen!2sin"
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 mb-3 mb-lg-0">
                            ...
                            <ul class="footer-link list-unstyled menu mb-0">
                                ...
                                <li class="mb-2"><a class="link d-block font-weight-500"
                                        href="<?php echo html_escape($top->menu_slug);?>"><?php echo html_escape($top->menu_name);?></a>
                                </li>
                                <?php } ?>
                            </ul>
                        </div>
