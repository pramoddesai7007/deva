...
<link href="https://fonts.googleapis.com/css2?family=League+Spartan:wght@200&family=Mukta:wght@300&family=Poppins:ital,wght@0,100;0,300;1,400&family=Roboto+Condensed&family=Roboto:wght@300&family=Sansita+Swashed:wght@300&family=Tapestry&display=swap" rel="stylesheet">
</head>
        ...
        <div class="d-flex order-lg-last">
            <ul class="navbar-right d-flex align-items-center list-unstyled mb-0">
             ...
             <!-- <button type="submit" class="border-0 d-none d-lg-inline-block nav-link">
                                <i class="far fa-calendar-alt mr-2"></i><span><?php echo display('my_profile')?></span>
                            </button> -->
