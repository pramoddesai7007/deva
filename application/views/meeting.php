...
<body>
        ...
        <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="assets/img/conf1.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="assets/img/conf2.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                <img src="assets/img/conf3.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
    ...
    <section class="section-scroll">
        <div class="container">
            <div class="row">
                <div class=" col-12">
                    <h2 class="text-center mt-3">BANQUETS & MEETINGS</h2>
                    <p>The hotel dedicates two floors for business, private lounges and entertainment. Set in a personalized
                        and stylish manner, the elite hotel is the place to be for 'business'.</p>
                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Feel The Information</h1>
                                ...
                                <div class="modal-body">
                                    ...
                                    <br>
                                    <div>
                                        <button type="button" class=" btnn-color btn btn-"
                                            data-bs-dismiss="modal">Send</button>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button"  class=" btnn-color1 btn btn-" data-bs-dismiss="modal">Close</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col- col-lg-6 mt-3">
                        <div class="image-container">
                            <img class="img-fluid" src="assets/img/con3.png" alt="...">
                            <div class="image-text">
                                <h5 class="text-white text-center">

                                <a class="text-white text-center" href="<?php echo base_url();?>Conferenceroom/conferenceroom">CONFERENCE ROOMS</a>
                                </h5>
                                <ul class="text-white" style="list-style:none ;">
                                    <li>A1: 18-seater meeting rooms
                                    </li>
                                    <li>A2: 14-seater meeting rooms

                                    </li>
                                    <li>A3: 30-seater meeting rooms

                                    </li>
                                    <li>A4: 25-seater meeting rooms
                    ...
                    <div class="col- col-lg-6 mt-3">
                        <div class="image-container">
                            <img class="img-fluid " src="assets/img/con1.png" alt="..." style="height: 260px;">
                            <div class="image-text">
                                <h5 class="text-white text-center">
                                <a class="text-white text-center" href="<?php echo base_url();?>Squarehall/squarehall">RECTANGE & SQUARE BANQUET HALL</a>
                                </h5>
                                <p class="text-white">The hotel provides extensive banqueting space spread over 1600 square feet, including
                                    three private rooms and an opulent, column-less Ballroom. The Ballroom is connected
                                    with spacious pre-function areas. The space can accommodate round table seating for
                                    160 people and theater style arrangement for 400 people.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col- col-lg-6 mt-3">
                        <div class="image-container">
                            <img class="img-fluid" src="assets/img/meetnew1.png" alt="...">
                            <div class="image-text">
                                <h5 class="text-white text-center">
                                <a class="text-white text-center" href="<?php echo base_url();?>Lobyhall/lobyhall">LOBBY LEVEL HALL</a>

                                </h5>
                                <p class="text-white">State of the art Banquet Hall at Lobby Level with Unique natural sunlight spread over
                                    1500 sq. ft. and separate dining area with capacity of 100 in round table & 200 in
                                    theatre seating.</p>
                            </div>
                        </div>
                    </div>
