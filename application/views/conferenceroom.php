        ...
        <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo base_url();?>assets/img/conf2.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="<?php echo base_url();?>assets/img/conf1.jpg" class="d-block w-100" alt="...">
                </div>
                <!-- <div class="carousel-item">
                <img src="<?php echo base_url();?>assets/img/meetnew1.png" class="d-block w-100" alt="...">
                </div> -->
            </div>
    ...
    <section class="section-scroll">
        <div class="container">
            <div class="row">
                ...
                <div class="p-3" >
                    <h4>A1, A2, A3 CONFERENCE ROOMS
                    </h4>
                  

                    <p>
                    The hotel elite dedicates two floors for Business, Private Lounge & Entertainment. Set in a personalized & stylish manner.The hotel elite is the place to be for 'Business'.
                    <br>
                    The hotel elite dedicates two floors for business, private lounges and entertainment. Set in a personalized and stylish manner, the hotel elite is the place to be for 'business'.
                    </p>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h6 class="modal-title " id="staticBackdropLabel">Feel The Information</h6>
