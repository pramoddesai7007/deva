        ...
        <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo base_url();?>assets/img/newlive.jpg" class="d-block w-100" alt="Image 1">
                </div>
                <div class="carousel-item">
                <img src="<?php echo base_url();?>assets/img/dinee3.png" class="d-block w-100" alt="Image 1">

                </div>
                <!-- <div class="carousel-item">
                    <img src=" <?php echo base_url();?>assets/img/huru1.jpg" class="d-block w-100" alt="Image 3">
                </div> -->
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="p-3" >
                    ...
                    <p>
                        Satara's finest Japanese dining experience with a live Teppanyaki counter - serving fresh Sushi,
                        Sashimi and other Japanese delicacies.

                        Sit at the live table observing theatrical culinary drama or opt for the intimate crystal cocoon
                        enclosed in lavish red leather and gold bamboos.
                    </p>
                    <h6>For query : +91 9075000750 | Email - hotelelitesatara@gmail.com</h6>
