...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light header-sticky shadow-sm">
        <!-- <a class="navbar-brand" href="<?php echo base_url();?>"><img
                ...
                alt=""></a> -->
                <img src="<?php echo base_url();?>assets/img/elite-logo.jpeg" style="width:168px ; height:65px ; margin-top:10px ; margin-left:5px ;">
    ...
    <section class="section-scroll">
        <div class="container">
            <div class="row">
                ...
                <div>
                    <h4>NAVRATRI CELEBRATION
                    </h4>
                    <div class="row first-celebration">


                        <div class="col-lg-4 col-md-4">
                            <img src="assets/img/navratri.jpg" class="img-fluid" alt="...">
                        </div>
                        ...
                        <div class="col-lg-5 col-md-4">
                            <ul>
                                ...
                                <li>Inclusive of room.
                                </li>
                                <li>Welcome Drink on Arrival @ SkyBar
                                </li>
                                <li>Complimentary High speed WiFi.
                                </li>
                                <li>Complimentary Breakfast
                                </li>
                                <li>Complimentary Dinner/Lunch
                                </li>
                                <li>Tea/ Coffee maker available
                                </li>
                                <li>02 bottles of packaged drinking water
                                </li>
                                <li>Electronic safe in room
                                </li>
                                <li>Iron with Ironing Board (on request)
                                </li>
                                <li>15% Discount on Food and Beverages.</li>
                                <li>*T&C APPLY</li>
                                <li>Validity: 15th - 25th October 2023</li>
                            </ul>
                        </div>


                        <div class="col-lg-3 col-md-4 button-bg text-center mt-5">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h6 class="modal-title fs-5" id="staticBackdropLabel">Feel The
                                                Information</h6>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <br>
                                            <div>
                                                <input class="col-12" type="text" placeholder="Mobile Number">
                                            </div>
                                            <br>
                                            <div>
                                                <input class="col-12" type="text" placeholder="Your Email">
                                            </div>
                                            <br>
                                            <div>
                                                <textarea class="col-12" placeholder="Message" name="" id="" cols="30"
                                                    rows="3"></textarea>
                                            </div>
                                            <br>
                                            <div>
                            ...
                            <div class="mt-3">
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal1"
                ...
                <div class="mt-3">
                    <h4>STAY MORE AND SAVE MORE
                    </h4>
                    <div class="row first-celebration">


                        <div class="col-lg-4 col-md-4">
                            <img src="assets/img/stay1.jpg" class="img-fluid" alt="...">
                        </div>
                        ...
                        <div class="col-lg-5 col-md-4">
                            <ul>
                                ...
                                <li>3 Hrs early check in - Subject to Availability
                                </li>
                                <li>3 Hrs Late check out - Subject to Availability
                                </li>
                                <li>15% Discount on Food and Beverages.</li>
                                <li>*T&C APPLY</li>
                                <li>Validity: 15th - 25th October 2023</li>
                ...
                <div class="mt-3">
                    <h4>DEAL-ICIOUS CORPORATE DINNER CELEBRATION
                    </h4>
                    <div class="row first-celebration">


                        <div class="col-lg-4 col-md-4">
                            <img src="assets/img/deal1.jpg" class="img-fluid" alt="...">
                        </div>
                        ...
                        <div class="col-lg-5 col-md-4">
                            <ul>
                                ...
                                <li>At ADDAH - Starting INR 1599 + tax
                                </li>
                                <li>Unlimited Starter, Main-Course & Desserts
                                </li>
                                <li>Amidst Rooftop Views, Swimming Pool & Open Sky BAR
                                </li>
                            </ul>
                        </div>
                ...
                <div class="mt-3">
                    ...
                    <div class="row first-celebration">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <img src="assets/img/spap.jpg" class="img-fluid" alt="...">
                        </div>
                        ...
                        <div class="col-lg-5 col-md-4">
                            <ul>
                                ...
                                <li>Have you tried the couple spa package at O Hotel yet? Book a couple spa at just INR
                                    6549 + Tax
                                </li>
                                <li>(Any One) Swedish massage / Aroma Therapy / Balinese Massage / Deep Tissue Massage
                                </li>
                                <li>Steam & Sauna Bath
                                </li>
                                <li>Signature Herbal Tea
                                </li>
                            </ul>
                        </div>
                ...
                <div class="mt-3">
                    <h4>PRESENTIAL SUITE WITH SPA OFFER
                    </h4>
                    <div class="row first-celebration">


                        <div class="col-lg-4 col-md-4">
                            <img src="assets/img/last1.jpg" class="img-fluid" alt="...">
                        </div>
                        ...
                        <div class="col-lg-5 col-md-4">
                            <ul>
                                ...
                                <li>Exclusive Presidential Suite Room with Couple Spa Starting 24,999*/- Per Night
                                </li>
                                <li>Accommodation in Presidential Suite on High Floors.
                                </li>
                                <li>Complimentary High speed WiFi.
                                </li>
                                <li>Two way Airport Transfer
                                </li>
                                <li>Swimming pool access free
                                </li>
                                <li>Complimentary Breakfast
                                </li>
                                <li>Tea/ Coffee maker available
                                </li>
                                <li>04 bottles of packaged drinking water
                                </li>
                                <li>Electronic safe in room
                                </li>
                                <li>Iron with Ironing Board (on request)
                                ...
                                <li>20% Discount on Food on all outlet.
                                </li>
                                <li>20% Discount on Laundry.
                                </li>
                                <li>Gym access free.
                                </li>
                                <li>Chocolate platter
                                </li>
                                <li>Chocolate platter
                                </li>
                                <li>Fruit basket.
                                ...
                                <li>Bottle of Wine (375 ML)
                                </li>
                                <li>Free One drink - Cocktail/Mocktail/ any IMFL at Skybar from 6pm to 7:30 Pm
                                </li>
                                <li>Relaxing charles chair in room.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-4 button-bg text-center mt-5">
                            ...
                            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="staticBackdropLabel">Feel The
                                                Information</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 text-center mt-2">
                    <div class="card" style="width: 18rem;">
                        <img src="assets/img/location1.jpeg" class="card-img-top mx-auto d-block w-25 mt-2" alt="..."
                ...
                <div class="col-lg-4 col-md-6 text-center mt-2">
                    <div class="card" style="width: 18rem;">
                        <img src="assets/img/phone1.jpeg" class="card-img-top mx-auto d-block w-25 mt-2" alt="..."
                            style="border-radius:7px;">
                        <br>
                        <br>
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-md-6 text-center mt-2">
                    <div class="card" style="width: 18rem;">
                        <img src="assets/img/mail1.png" class="card-img-top mx-auto d-block w-25 mt-2" alt="..."
                            style="border-radius:7px;">
                        <br>
                        <br>
                        <div class="card-body">
    ...
    <section>
        <div>
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d243067.16263997694!2d73.84178460795349!3d17.842177813488046!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc25bb9d17cbde1%3A0x9f44ea297f3b80bc!2sWade%20phata!5e0!3m2!1sen!2sin!4v1697726004372!5m2!1sen!2sin"
            ...
            <div class="row">
                ...
                <div class="new-cards2 col-sm-6 col-md-4 mt-2">
                    <ul class="p-4">
                        ...
                        <li>Pune International Airport: 5.8 KMs
                        </li>
                        <li>Pune Railway Station: 4.2 Kms
                        </li>
                    </ul>
                </div>
                ...
                <div class="new-cards3 col-sm-6 col-md-4 mt-2">
                    <ul class="p-4">
                        ...
                        <li>Osho Ashram: 0.5 KM
                        </li>
                        <li>Aga Khan Palace Park: 2.9 KM
                        </li>
                        <li>Shaniwar Wada: 6.6 KM
                        </li>
                        <li>Savitribai Phule Pune University: 8.4 KM
                        </li>
                        <li>Sinhagad Fort: 34.5 K
                        </li>
                        </li>
                    </ul>
                </div>
