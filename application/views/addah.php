        ...
        <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo base_url();?>assets/img/blog1.jpg" class="d-block w-100" alt="Image 1">
                </div>
                <div class="carousel-item">
                    <img src=" <?php echo base_url();?>assets/img/blog4.jpg" class="d-block w-100" alt="Image 2">
                </div>
                <!-- <div class="carousel-item">
                    <img src=" <?php echo base_url();?>assets/img/addh1.jpg" class="d-block w-100" alt="Image 3">
                </div> -->
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="p-3" >
                    ...
                    <p>
                    A beautiful rooftop lounge space, Addah, captures the fusion of the two elements Fire and Water. Time flies overlooking the expanse of the Satara skyline, the setting sun or the rising moon. Get lost in the rhythm of tranquil water of the pool on the O terrace as our chefs fire up the live charcoal counter to spice up your taste buds with Indian specialties.
                    </p>
