        ...
        <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="assets/img/spa3.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="assets/img/spa2.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="assets/img/spa1.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
...
<br>
            <!-- <div class="text-center">
            <img  src="assets/img/spaimg.png" class="img-fluid" alt="..." style="height:200px ;" > 
            </div> -->
            <div class="gradient-box-1 ">
                <h2 class="text-white coming-soon " >Coming Soon</h2>
                <h3 class="text-white" >Be the first to know when our new site is live</h3>
            </div>
            <div class="row">
                <!-- <div>
                  
                    <h6>ENJOY OUR SPA & SALON</h6>
                    <p>Located on the upper floors is the The O Spa. It is an ultimate solution to relax your mind, body
                        and soul. Indulge in some unabashed pampering at The O Salon. Either way, nirvana has never been
                        so relaxing before.</p>
                </div> -->
                ...
                <!-- <div>
                   ...
                   <ul>
                    ...
                    <li>Sauna</li>
                    <li>Gym</li>
                    <li>Manicure & Pedicure Station</li>
                    <li>Haircut & Hairwash Station</li>
                    <li>Spa Treatment Rooms</li>
                    <li>   <span>For Booking :- +91 9075000750 |</span>  <span>Email :- hotelelitesatara@gmail.com</span></li>
                   </ul>
                </div> -->
            </div>
        </div>
