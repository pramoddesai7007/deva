        ...
        <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo base_url();?>assets/img/dinenew2 1.png" class="d-block w-100" alt="Image 1">
                </div>
                <div class="carousel-item">
                    <img src=" <?php echo base_url();?>assets/img/fam1.png" class="d-block w-100" alt="Image 2">
                </div>
                <!-- <div class="carousel-item">
                    <img src=" <?php echo base_url();?>assets/img/sky1.jpg" class="d-block w-100" alt="Image 3">
                </div> -->
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="p-3" >
                    ...
                    <p>
                    Located on the Rooftop, The Family Resto offers a wide variety of spirits and cocktails. Enjoy your drink under the starlit sky or dip your feet in the reflecting pool seating - a perfect ambience for the evening.
