                    ...
                    <div class="row no-gutters custom-search-input-2 search-form-content">
                        <div>
                             <button type="submit" class="border-0 d-none d-lg-inline-block nav-link">
                              ...
                              <a class="text-white" href="http://localhost/hotelelite/my-profile">My Profile</a>
                            </button> 
                        </div>
                    </div>
                    <?php echo form_close() ?>
    ...
    <section>
        ...
        <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <img src="assets/img/dinee2.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="assets/img/dinee1.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="assets/img/dinee3.png" class="d-block w-100" alt="...">
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="p-3" >
                    ...
                    <h6>DRINK & DINE WITH US</h6>
                    <p>
                        At Hotel Elite, we understand the importance of comfort and convenience when it comes to special
                        occasions. That's why we provide end-to-end dining services, including food, crockery, cutlery,
                        service staff, and buffet counter decoration, to ensure that your special event is
                        unforgettable. Whether you're planning an intimate dinner with Family or enjoy with Friends or a
                        banquet for a larger group, our top professionals will take care of every detail to create a
                        luxurious dining experience with your loved ones and make memories that last a lifetime.
                    </p>
                </div>
                ...
                <div class="row text-center">
                    <div class="col-12 col-md-6 col-lg-6 mt-3">
                        <div class="image-container">
                            <img class="img-fluid" src="assets/img/playarea.jpg" alt="..." style="height: 250px; width: 350px;">
                            <div class="image-text-dinning">
                                <h4 class="text-white text-center">

                                    <a class="text-white text-center"
                                        href="<?php echo base_url();?>Bluepepper/bluepepper"> Play Area.
</a>
                                </h4>
                                <p class="text-white">An all day dining space offers cosmopolitan menus with seasonal twists</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-6 mt-3">
                        <div class="image-container">
                            <img class="img-fluid " src="assets/img/music.jpg" alt="..."  style="height: 250px; width: 350px;">
                            <div class="image-text-dinning">
                                <h4 class="text-white text-center">
                                    <a class="text-white text-center" href="<?php echo base_url();?>Harajuku/harajuku">
                                        Live Music</a>
                                </h4>
                                <p class="text-white">Satara's finest Japanese dining experience with a live Teppanyaki counter</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-6 mt-3">
                        <div class="image-container">
                            <img class="img-fluid" src="assets/img/djnights.jpg" alt="..."  style="height: 250px; width: 350px;">
                            <div class="image-text-dinning">
                                <h4 class="text-white text-center">

                                    <a class="text-white text-center" href="<?php echo base_url();?>Addah/addah">
                                        Dj Nights</a>
                                </h4>
                                <p class="text-white">A beautiful rooftop lounge space,  captures the fusion of the two elements Fire
                                    and Water
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-6 mt-3">
                        <div class="image-container">
                            <img class="img-fluid" src="assets/img/resto1.jpg" alt="..." style="height: 250px; width: 350px;">
                            <div class="image-text-dinning">
                                <h4 class="text-white text-center">

                                    <a class="text-white text-center" href="<?php echo base_url();?>Skybar/skybar"> 
                                        Family Resto</a>
                                </h4>
                                <p class="text-white">Located on the Rooftop, The Sky bar offers a wide variety of spirits and cocktails
                                </p>
                            </div>
                        </div>
                    </div>
