        ...
        <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo base_url();?>assets/img/dinee2.jpg" class="d-block w-100" alt="Image 1">
                </div>
                <!-- <div class="carousel-item">
                <img src="<?php echo base_url();?>assets/img/gar2.png" class="d-block w-100" alt="Image 1">
                </div> -->
                <div class="carousel-item">
                <img src="<?php echo base_url();?>assets/img/gar3.png" class="d-block w-100" alt="Image 1">
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="p-3" >
                    ...
                    <p>
                        An all day dining space offers cosmopolitan menus with seasonal twists. Serving a wide variety
                        of cuisines along with Indian favorites, it caters to every ones palette.
                        <br>

                        An occasional spectacular buffet adds to the culinary drama.
                    </p>
