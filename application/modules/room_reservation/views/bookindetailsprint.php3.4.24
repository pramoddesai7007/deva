...
<table class="table table-striped table-hover" ><tr><td style="padding: 40px;padding-top: 10px;padding-bottom: 10px;border: 1px solid black;" celspacing="0">
    ...
    <table class="table table-striped table-hover" cellspacing="0">
        <tbody>
            ...
            <tr>
                <td colspan="2" style="text-align: center;border: 1px solid black;border-bottom: none;border-right: none;">
        Bill No. : <?php echo html_escape($bookinfo->booking_number);?>
                </td>
                <td colspan="4" style="text-align: center;border: 1px solid black;border-bottom: none;border-right: none;border-left: none;">
        <span style="font-size:17px;font-weight: bold;color:#17a2b8;">Reservation Details</span>
                </td>
                <td colspan="2" style="text-align: center;border: 1px solid black;border-bottom: none;border-left: none;">
        Booking Date : <?php echo date('d-m-Y h:i:s A',strtotime($bookinfo->date_time));?>
                </td>
            </tr>
            <tr>
                <td colspan="8" style="border: 1px solid black;border-top: none;">
            ...
            <tr>
                ...
                <th style="border: 1px solid black;text-align:center;">
                    <?php echo html_escape($bookinfo->total_gstamt);?>
                </th>
                <th style="border: 1px solid black;text-align:center;">
                    <?php echo $extraperson[$i]?>
                </th>
                <th style="border: 1px solid black;text-align:center;">
                    <?php echo html_escape($bookinfo->total_price-$bookinfo->total_gstamt);?>
                </th>
                <th style="border: 1px solid black;text-align:center;">
                    <?php echo html_escape($bookinfo->total_price); $tot_price += $bookinfo->total_price;?>
                </th>
            </tr>      
            <?php } $i++; ?>
            <tr>
