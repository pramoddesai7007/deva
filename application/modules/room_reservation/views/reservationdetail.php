        ...
        <form>
            ...
            <?php 
                ...
                for($i=0; $i<count($singleRoom); $i++){
                    $roominfo=$this->db->select("roomtype, bedcharge, personcharge")->from('roomdetails')->where('roomid',$singleRoom[$i])->get()->row();
                    $roomname.=$roominfo->roomtype.",";
                    $bedcharge.=$roominfo->bedcharge.",";
                    $personcharge.=$roominfo->personcharge.",";
                }
                
                $datediff = strtotime($bookinginfo->checkoutdate) - strtotime ($bookinginfo->checkindate);
            ...
            <div class="row">
                <div class="col-md-3 pr-md-1">
                    <div class="form-group">
                        <label class="font-weight-600"><?php echo "Bed" ?></label>
                        <div class=""><?php echo html_escape($bookinginfo->bed); ?></div>
                    </div>
                </div>
                <div class="col-md-3 pr-md-1">
                    <div class="form-group">
                        <label class="font-weight-600"><?php echo "Persons" ?></label>
                        <div class=""><?php echo html_escape($bookinginfo->person);?></div>
                    </div>
                </div>
                <div class="col-md-3 pr-md-1">
                    <div class="form-group">
                        <label class="font-weight-600"><?php echo "Children" ?></label>
                        <div class=""><?php echo html_escape($bookinginfo->child);?></div>
                    </div>
                </div>
                <div class="col-md-3 pr-md-1">
                    <div class="form-group">
                        <label class="font-weight-600"><?php echo "Duration" ?></label>
                        <div class=""><?php echo html_escape($totalnight)." Nights";?></div>
                    </div>
                </div>
            </div>
            <!-- end vivek -->
