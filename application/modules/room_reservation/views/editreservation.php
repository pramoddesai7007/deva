...
<div id="reservation">
    ...
    <div class="card mb-4">
        ...
        <input type="hidden" id="days" value="<?php echo html_escape($bookingdata->days); ?>">
        ...
        $total_gstamt = $bookingdata->total_gstamt; //kiran
        $totalamount = 0;
        $taxPercent = 0;
        $scharge = 0;
        ...
        // $totalamount = $totalamount+$total_gstamt+$scharge; //kiran
        $totalamount = $totalamount+$scharge; // vivek
        ...
        $gst = explode(",",$bookingdata->gst);
        $gstamt = explode(",",$bookingdata->gstamt);
        ?>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered white-space-nowrap mb-0 room-list">
                    ...
                    <tbody>
                        <tr>
                            <th colspan="2"><?php echo display('room_info') ?><span style="padding-left: 30%;"></span>Complementery <input type="checkbox" name="complementary_checkbox" id="complementary_checkboxt<?php echo $r;?>" readonly="true" value="1" onclick="getcapcitys(<?php echo $r; ?>);"></th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="border-0">
                                                <div class="form-group mb-0">
                                                    <label
                                                        class="font-weight-600 mb-1"><?php echo display('gst') ?>
                                                        </label>
                                                    <div class="icon-addon addon-md input-left-icon">
                                                        <select class="selectpicker form-select" data-live-search="true"
                                                            data-width="100%" onchange="getgstamt(<?php echo $r; ?>)"
                                                            id="gst<?php echo $r;?>">
                                                            <option value="" selected>Choose
                                                                <?php echo display('gst') ?></option>
                                                            <?php foreach($gstlist as $gtype){ ?>
                                                            <option
                                                                <?php if($gtype->gst==$gst[$r+1]){echo 'selected';} ?>
                                                                value="<?php echo html_escape($gtype->gst); ?>">
                                            ...
                                            <!--td class="border-0">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div class="icon-addon addon-md input-left-icon">
                                                        <input type="number" readonly="true" min="0" class="form-control"readonly="true"
                                                            id="gst<?php echo $r; ?>"
                                                            placeholder="<?php echo display('gst') ?>"
                                                            value="<?php echo html_escape($gst[$r+1]);?>">
                                                        <label class="fas fa-child"></label>
                                                    </div>
                                                </div>
                                            </td-->
                                            <td class="border-0">
                                                <div class="form-group mb-0">
                                                    <label
                                                        class="font-weight-600 mb-1">#<?php echo display('gstamt') ?></label>
                                                    <div class="icon-addon addon-md input-left-icon">
                                                        <input type="number" readonly="true" min="0" class="form-control"
                                                            id="gstamt<?php echo $r; ?>"
                                                            placeholder="<?php echo display('gstamt') ?>"
                                                            value="<?php echo html_escape($gstamt[$r+1]);?>">
                                                        <label class="fas fa-child"></label>
                                                    </div>
                                                </div>
                                            </td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal"
                                                data-target="#exampleModal"><?php echo display("customer") ?></a>
                                            <!--a class="dropdown-item" href="javascript:void(0)" data-toggle="modal"
                            ...
                            <tr>
                                ...
                                <td class="border-0">
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="icon-addon addon-md">
                                            <input type="number" class="form-control form-control" onchange="getgstamt(<?php echo $r; ?>);"
                                                id="rent<?php echo $r; ?>"
                                                value="<?php echo html_escape($roomrate[$r+1]*$totaldays); //html_escape($roomrate[$r+1]); //kiran?>">
                                        </div>
                                    </div>
                                </td>
                                <td class="border-0">
                            ...
                            <tr>
                                ...
                                <td class="border-0">
                                    <input type="number" disabled class="form-control ex-room"
                                        ...
                                        value="<?php echo (!empty($extrachild[$r+1]*$price->personcharge/2)?html_escape($extrachild[$r+1]*$price->personcharge/2):"");?>"
                                        placeholder="<?php echo display('amnt') ?>">
                                </td>
                            </tr>
                        </tbody>
        ...
        <div class="card flex-fill w-100">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-0" id="tax_charge"><?php echo $total_gstamt //$taxPercent //kiran ?></label>
                            <input type="hidden" name="total_gstamt" id="total_gstamt" value="<?php echo $total_gstamt //kiran ?>">
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                    ...
                    <?php   $extrabed = array_sum(explode(",",$bookingdata->extrabed));
                            $extraperson = array_sum(explode(",",$bookingdata->extraperson));
                            $extrachild = array_sum(explode(",",$bookingdata->extrachild)); 
                                 
                    ?>
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-0"
                                id="bed_amount1"><?php echo ($extrabed * $price->bedcharge); ?></label>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-0"><?php echo "Persons" ?></label>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-0"
                                id="per_amount2"><?php echo ($extraperson * $price->personcharge);?></label>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-0"
                                id="child_amount3"><?php echo ($extrachild * ($price->personcharge / 2));?></label>
                        </div>
                    </div>
                    <!-- <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-0"
                                id="total_charge"><?php echo $totalamount*$totaldays; //$totalamount; //kiran ?></label>
                        </div>
                    </div> -->
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="icon-addon addon-md">
                                ...
                                <input type="text" disabled class="form-control" id="totalamount"
                                    value="<?php echo $totalamount*$totaldays; //$totalamount //kiran ?>" placeholder="Total amount">
                                <i
                                    class=""><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></i>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            ...
                            <div class="icon-addon addon-md">
                                <i
                                    class=""><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?></i>
                                <input type="number" disabled readonly="true" class="form-control" id="advanceamount"
                    ...
                    <table class="table table-borderless payment mb-0 ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <th class="border-0"><input type="number" id="cash_0" disabled class="form-control cash_amt"
                                        placeholder="Amount" value="" onchange="getTotal();"></th>
                                <td class="border-0 pr-0 text-right">
                                    <button type="button" onclick="delrow(0); call(0)" id="del0"
                                        class="btn btn-danger-soft del0"><i class="far fa-times-circle"></i></button>
                                </td>
                            </tr>

                            <!-- kiran edit advance payment -->
                            <?php $random = 0; ?>
                            ...
                            <tr>
                                <td class="border-0 pl-0">
                                    <div class="form-floating with-icon">
                                        <select class="selectpicker form-select" data-live-search="true"
                                            data-width="100%" onchange="paymode(<?php echo $random;?>)" id="paymentmode_<?php echo $random;?>">
                                            <option value="" selected>Choose <?php echo display("payment_mode") ?>
                                            </option>
                                            <?php foreach($paymentdetails as $ptype){ ?>
                                            <option value="<?php echo html_escape($ptype->payment_method) ?>" <?php echo $pay->paymenttype==$ptype->payment_method?"selected":"";?> >
                                                <?php echo html_escape($ptype->payment_method) ?></option>
                                            <?php } ?>
                                        </select>
                                        <label for="paymentmode"><?php echo display("payment_mode") ?></label>
                                    ...
                                    <div class="row mt-2" id="modedetails_<?php echo $random;?>" <?php echo $pay->paymenttype=="Cash Payment"?"hidden":"";?> >
                                        <?php if($pay->card_acc!=''){ ?>
                                        <div class="col">
                                            <input type="text" class="form-control form-control-sm" id="cardno_<?php echo $random;?>"
                                            placeholder="Card Number"value="<?php echo $pay->card_acc; ?>" required>
                                        </div><?php } ?>
                                        <div class="col">
                                            <?php if($pay->payment_date!="0000-00-00 00:00:00"){ ?>
                                            <input type="text" class="form-control form-control-sm" id="recdate_<?php echo $random;?>"
                                                placeholder="Date" value="<?php echo $pay->payment_date; ?>">
                                            <?php } ?>
                                            <?php if($pay->bank_name!=""){ ?>
                                            <select class="selectpicker form-select" data-live-search="true"
                                                data-width="100%" id="bankname_<?php echo $random;?>">
                                                <option value="" >Choose <?php echo display("bank_name") ?>
                                                </option>
                                                <?php foreach($banklist as $list){ ?>
                                                <option value="<?php echo html_escape($list->HeadName); ?>" <?php echo $pay->bank_name==$list->HeadName?"selected":"";?>  >
                                                    <?php echo html_escape($list->HeadName);?></option>
                                                <?php } ?>
                                            </select> <?php }?>
                                        </div>
                                ...
                                <th class="border-0"><input type="number" id="cash_<?php echo $random;?>" class="form-control cash_amt" value="<?php echo $pay->paymentamount; ?>" 
                                        placeholder="Amount" value="" onchange="getTotal();" ></th>
                                <td class="border-0 pr-0 text-right">
                                    <button type="button" onclick="delrow(<?php echo $random;?>); call(<?php echo $random;?>)" id="del<?php echo $random;?>"
                                        class="btn btn-danger-soft del<?php echo $random;?>"><i class="far fa-times-circle"></i></button>
                                </td>
                            </tr>
                            <?php } ?>
                            <!-- end kiran edit advance payment --->
                                    ...
                                    <div class="col-md-12 mb-3" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;">
                                        ...
                                        <div class="modal-footer py-2 px-4">
                                            ...
                                            <button type="button" disabled id="addoldcustomer"
                                                class="btn btn-primary"><?php echo display("ad") ?></button><br/><span style="color:red;font-size:11px">*Note : Check customer number exist else fill below details for new customer.</span>
                                        </div>
                                        <!-- -->
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="icon-addon addon-md">
                                            <input type="text" name="gst_no" class="form-control" id="gst_no"
                                                placeholder="<?php echo display("gst_no") ?>">
                                            <label class="fas fa-globe-americas"></label>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="icon-addon addon-md">
                                            <input type="text" name="employee_id" class="form-control" id="employee_id"
                                                placeholder="<?php echo display("employee_id") ?>">
                                            <label class="fas fa-globe-americas"></label>
                                        </div>
                                        </div>
                                    </div>
...
<input type="hidden" id="intime"
    value="<?php echo date("Y-m-d H:i"); ?> <?php // echo html_escape($inouttime->checkintime); ?>">
...
<script>
    function calculateSum() { 
      ...
      var amount1 = parseFloat(document.getElementById('amount1-1').value) || 0;
      var amount2 = parseFloat(document.getElementById('amount2-1').value) || 0;
      var amount3 = parseFloat(document.getElementById('amount3-1').value) || 0;
...
<script>
  $(document).ready(function(){
      ...
      var totalamount = parseFloat(document.getElementById('totalamount').value) || 0;
        ...
        var bed_amount1 = parseFloat(document.getElementById('bed_amount1').textContent) || 0;
        var per_amount2 = parseFloat(document.getElementById('per_amount2').textContent) || 0;
        var child_amount3 = parseFloat(document.getElementById('child_amount3').textContent) || 0;
        var sum1 = bed_amount1 + per_amount2 + child_amount3;
      var sum = totalamount + sum1;
    //   alert(sum);
      $("#sum").text(sum)
