                ...
                <table class="table table-sm table-borderless mb-0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><strong id="inbknumber"><?php echo html_escape($bookingdata[0]->booking_number) ?></strong>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-floating with-icon">
                                        <input type="text" class="form-control" readonly placeholder="<?php echo display("bopkig_type") ?>" value="<?php echo html_escape($bookingts->booking_type) ?>">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="form-floating with-icon">
                                        <input type="text" class="form-control" readonly placeholder="<?php echo display("booking_source") ?>" value="<?php echo html_escape($bookingts->booking_sourse) ?>">
                                    </div>
                                </td>
                            </tr>
                        <?php } ?>
            ...
            <div class="card-body">
                ...
                ?>
                    <div class="customer-radio custom-control custom-radio pl-0 rounded bg-white border mb-2">
                        <input type="radio" id="custom_radio_<?php echo $j; ?>" <?php if (count($bookingdata) > 1) { ?>onclick="userselect(<?php echo $j; ?>)" <?php } ?> name="customer-radio" class="custom-control-input" <?php if ($j == 0) {
                                                                                                                                                                                                                                    echo "checked";
                                                                                                                                                                                                                                } ?> value="<?php echo html_escape($bookingdata[$j]->bookedid) ?>">
                        <label class="custom-control-label d-flex align-items-center justify-content-between py-2 pr-3" for="custom_radio_<?php echo $j; ?>">
                            <span>
                                ...
                                <span class="d-block"><?php echo html_escape($bookingdata[$j]->checkindate) . " - "; ?><?php echo html_escape($bookingdata[$j]->checkoutdate) ?></span>
                            </span>
                        </label>
                    </div>
                <?php } ?>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    //      echo "($tax->taxname".html_escape($tax->rate)."% )"; echo $singletax = ($tax->rate*$total)/100; $allsingle += $singletax; 
                                                    ?>
                                                    <!-- <br> -->
                                                    <?php // } 
                                                    ?>

                                                    <?php echo $singletax[$n] = ($gst[$n] * $total) / 100;  ?>

                                                </td>
                                                <td>
                                                    <?php $singletax[$n] = ($gst[$n] * $total) / 100; ?>
                                                    <?php //echo $subtotal = $total + $singletax[$n]; 
                                                    echo $subtotal = $total; 
                                                    ?>
                                                </td>
                                            </tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><strong><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><span id="allroomrent"><?php echo html_escape($allroomrent); ?></span><?php if ($currency->position == 2) {
                                                                                                                        echo html_escape($currency->curr_icon);
                                                                                                                    } ?></strong>
                            </td>
                        </tr>
                        <tr>
                            <th class="pl-0">
                                ...
                                <div class="d-flex align-items-center white-space-nowrap mb-1">
                                    <input type="number" min="0" disabled id="percent" class="form-control form-control-xs" autocomplete="off">
                                    <div class="ml-1 mr-3">(%) (<?php echo display("or") ?>)</div>
                                </div>
                                <div class="d-flex align-items-center white-space-nowrap">
                                    <input type="number" min="0" disabled id="amount" class="form-control form-control-xs" autocomplete="off">
                        ...
                        <tr>
                            ...
                            <td><strong><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><span id="disamount">0</span><?php if ($currency->position == 2) {
                                                                                echo html_escape($currency->curr_icon);
                                                                            } ?></strong>
                            </td>
                        </tr>
                        <?php if ($promocode > 0) { ?>
                            <tr>
                                ...
                                <td><strong><?php if ($currency->position == 1) {
                                                echo html_escape($currency->curr_icon);
                                            } ?><span id="disamount"><?php echo html_escape($promocode); ?></span><?php if ($currency->position == 2) {
                                                                                                                        echo html_escape($currency->curr_icon);
                                                                                                                    } ?></strong>
                                </td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td><strong><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><span id="scharge"><?php echo $scharge = ($allroomrent * $setting->servicecharge) / 100; ?></span><?php if ($currency->position == 2) {
                                                                                                                                                    echo html_escape($currency->curr_icon);
                                                                                                                                                } ?></strong>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><strong><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><span id="totalroomrentamount"><?php echo $allroomrent += $scharge; ?></span><?php if ($currency->position == 2) {
                                                                                                                                echo html_escape($currency->curr_icon);
                                                                                                                            } ?></strong>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td hidden>
                                <strong><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><span id="oldallroomrentandtax"><?php echo $allroomrentandtax += $scharge; ?></span><?php if ($currency->position == 2) {
                                                                                                                                    echo html_escape($currency->curr_icon);
                                                                                                                                } ?></strong>
                            </td>
                            <td><strong><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><span id="allroomrentandtax"><?php echo $allroomrentandtax; ?></span><?php if ($currency->position == 2) {
                                                                                                                        echo html_escape($currency->curr_icon);
                                                                                                                    } ?></strong>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><strong><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><span id="allcomplementarycharge"><?php echo $allcomplementarycharge *= $days; ?></span><?php if ($currency->position == 2) {
                                                                                                                                        echo html_escape($currency->curr_icon);
                                                                                                                                    } ?></strong>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><strong><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><span id="allbpccharge"><?php echo html_escape($allbpccharge); ?></span><?php if ($currency->position == 2) {
                                                                                                                        echo html_escape($currency->curr_icon);
                                                                                                                    } ?></strong>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><strong><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><span id="alladvanceamount"><?php echo html_escape($alladvanceamount); ?></span><?php if ($currency->position == 2) {
                                                                                                                                echo html_escape($currency->curr_icon);
                                                                                                                            } ?></strong>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><strong>
                                    <?php if ($currency->position == 1) {
                                        echo html_escape($currency->curr_icon);
                                    } ?><span id="payableamount"><?php echo $payableamount = $allroomrentandtax + $allcomplementarycharge + $allbpccharge - $alladvanceamount - $promocode; ?></span><?php if ($currency->position == 2) {
                                                                                                                                                                                                            echo html_escape($currency->curr_icon);
                                                                                                                                                                                                        } ?></strong>
                            </td>
                        </tr>
        ...
        <div class="card flex-fill w-100 mb-4">
                ...
                <table class="table table-sm table-borderless mb-0">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="number" min="0" id="additionalcharge" class="form-control form-control-sm" value="0" autocomplete="off">
                            </td>
                        </tr>
                        <tr>
                            <th class="pl-0"><?php echo display("additional_charge_comments") ?></th>
                            <td>
                                <textarea class="form-control" placeholder="<?php echo display("additional_charge_comments") ?>"></textarea>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="card-body">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><strong>
                                    <?php if ($currency->position == 1) {
                                        echo html_escape($currency->curr_icon);
                                    } ?><span id="netpayableamount"><?php echo html_escape($payableamount); ?></span><?php if ($currency->position == 2) {
                                                                                                                            echo html_escape($currency->curr_icon);
                                                                                                                        } ?></strong>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><strong><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><span id="creditamt">0.00</span><?php if ($currency->position == 2) {
                                                                                echo html_escape($currency->curr_icon);
                                                                            } ?></strong>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><strong><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><span id="complemetaryamt">0.00</span><?php if ($currency->position == 2) {
                                                                                        echo html_escape($currency->curr_icon);
                                                                                    } ?></strong>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><strong><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><span id="payableamt"><?php echo $payableamount + $poolbillamt + $restbill + $hallbill + $parkingbill; ?></span><?php if ($currency->position == 2) {
                                                                                                                                                                echo html_escape($currency->curr_icon);
                                                                                                                                                            } ?></strong>
                            </td>
                        </tr>
                ...
                <div class="text-right">
                    <button hidden type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#currencyConverterModal">
                    ...
                    <tbody>
                        <?php if ((!empty($poolbill))) { ?>
                            <tr>
                                ...
                                <td class="text-right"><button type="button" id="poolprint" onclick="podataprintflist()" class="btn btn-success btn-sm"><i class="fas fa-print"></i></button></td>
                            </tr>
                        <?php } ?>
                        <?php if (!empty($restaurantbill)) { ?>
                            <tr>
                                ...
                                <td class="text-right"><button type="button" id="orderprint" onclick="restaurantBill()" class="btn btn-success btn-sm"><i class="fas fa-print"></i></button></td>
                            </tr>
                        <?php } ?>
                        <?php if (!empty($hallroombill)) { ?>
                            <tr>
                                ...
                                <td class="text-right"><button type="button" id="hallprint" onclick="hallRoomBill()" class="btn btn-success btn-sm"><i class="fas fa-print"></i></button></td>
                            </tr>
                        <?php } ?>
                        <?php if (!empty($carParkingBill)) { ?>
                            <tr>
                                ...
                                <td class="text-right"><button type="button" id="parkingprint" onclick="carParkingBill()" class="btn btn-success btn-sm"><i class="fas fa-print"></i></button></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
                ...
                <table class="table table-sm table-borderless mb-0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" min="0" id="creditamount" disabled class="form-control form-control-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea class="form-control" placeholder="<?php echo display("remarks") ?>" id="floatingTextarea"></textarea>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <tbody>
                        <tr>
                            <td class="border-0 pl-0">
                                <div class="form-floating with-icon">
                                    <select class="selectpicker form-select" data-live-search="true" data-width="100%" onchange="paymode(0)" id="paymentmode_0">
                                ...
                                <div class="row mt-2" id="modedetails_0" hidden>
                                    <div class="col">
                                        <input type="text" class="form-control form-control-sm" id="cardno_0" placeholder="Card Number" required>
                                    </div>
                                    <div class="col">
                                        <input type="text" class="form-control form-control-sm" id="recdate_0" placeholder="Date">
                                        <select class="selectpicker form-select" data-live-search="true" data-width="100%" id="bankname_0">
                            ...
                            <th class="border-0"><input type="number" id="cash_0" disabled class="form-control" placeholder="Amount" value=""></th>
                            <td class="border-0 pr-0 text-right">
                                <button type="button" onclick="delrow(0)" id="del0" class="btn btn-danger-soft del0"><i class="far fa-times-circle"></i></button>
                            </td>
                        </tr>
                    </tbody>
                </table>
                <div class="text-right py-2">
                    <button type="button" class="btn btn-warning btn-sm" id="multipayment"><i class="fas fa-plus"></i></button>
                </div>
            </div>
        </div>
    </div>
                ...
                <table class="table table-sm table-borderless mb-0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="number" min="0" id="complementaryamount" disabled class="form-control form-control-sm"></td>
                ...
                <table class="table table-sm table-borderless mb-0">
                    <tbody>
                        <tr>
                            ...
                            <td><strong><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><span id="balance">0.00</span><?php if ($currency->position == 2) {
                                                                                echo html_escape($currency->curr_icon);
                                                                            } ?></strong>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><strong><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><span id="collectedamt">0.00</span><?php if ($currency->position == 2) {
                                                                                    echo html_escape($currency->curr_icon);
                                                                                } ?></strong>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><strong><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><span id="refunddamt">0.00</span><?php if ($currency->position == 2) {
                                                                                    echo html_escape($currency->curr_icon);
                                                                                } ?></strong>
                            </td>
                        </tr>
...
<div class="d-lg-flex align-items-center justify-content-between">
    ...
    <div class="mt-3 mt-lg-0">
        ...
        <button type="button" disabled id="checkout" onclick="checkout()" class="btn btn-info btn-lg"><?php echo display("checkout") ?></button>
    </div>
</div>
...
<!-- <table class="" style="width:100%;border-collapse: collapse;" cellpadding="0" cellspacing="0">
            ...
            <tbody>
                ...
                <tr><?php //var_dump($bookingdata[0]); 
                    ?>
                    <td rowspan="3" style="text-align: left;padding: 5px;font-size: 12px;vertical-align: top;" colspan="3"><?php echo $bookingdata[0]->firstname;
                                                                                                                            echo " ";
                                                                                                                            echo $bookingdata[0]->lastname; ?><br>
                ...
                ?>
                <tr>
                    <td colspan="5" style="text-align: left;padding: 5px;font-size: 12px; margin-top: 10px;"></td>
            ...
            <tfoot style="position: fixed;bottom: 0;">  
                <tr> 
                    <td colspan="8" style="border: none;border-top: 1px solid black;padding: 5px;font-size: 10px;">
...
<!-- <table class="" style="width:100%;border-collapse: collapse;" cellpadding="0" cellspacing="0">
            ...
            <tbody>
                ...
                <tr> 
                    <td colspan="1" style="border: 1px solid black;border-right: none;padding: 5px;">
                        <div><img src="<?php echo base_url(); ?><?php echo html_escape(!empty($commominfo->invoice_logo) ? $commominfo->invoice_logo : 'assets/img/header-logo.png') ?>" class="img-fluid mb-3" alt=""></div>
                    </td>
                    <td colspan="4" style="border: 1px solid black;border-left: none;text-align: left;padding: 5px;">
                        <address>
                        <strong><h2><?php echo html_escape($setting->title); ?></strong></h2>
                        <strong>Address :-</strong><?php echo html_escape($setting->address); ?><br>
                        <strong>Contact No :-</strong><?php echo html_escape($setting->phone); ?><br>
                    ...
                    <td colspan="1" style="border: 1px solid black;border-right: none;padding: 5px;border-left: 1px dotted lightgrey;">
                        <div><img src="<?php echo base_url(); ?><?php echo html_escape(!empty($commominfo->invoice_logo) ? $commominfo->invoice_logo : 'assets/img/header-logo.png') ?>" class="img-fluid mb-3" alt=""></div>
                    </td>
                    <td colspan="4" style="border: 1px solid black;border-left: none;text-align: left;padding: 5px;">
                        <address>
                ...
                <tr> 
                    <td colspan="5" style="border: none;border-bottom: 1px solid black;">
                        <div style="padding :5px;"></div>
                    </td>

                    <td colspan="5" style="border: none;border-bottom: 1px solid black;border-left: 1px dotted lightgrey;">
                        <div style="padding :5px;"></div>
                    </td>
                </tr>
                <tr>
                    <th style="text-align: left;padding: 5px;font-size: 12px;">NAME & ADDRESS</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;">ROOM NO.</th>       
                    <th style="text-align: left;padding: 5px;font-size: 12px;">TYPE:</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;">GUEST:</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;">GROUP/CREW ID:</th>

                    <th style="text-align: left;padding: 5px;font-size: 12px;border-left: 1px dotted lightgrey;">NAME & ADDRESS</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;">ROOM NO.</th>       
                    <th style="text-align: left;padding: 5px;font-size: 12px;">TYPE:</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;">GUEST:</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;">GROUP/CREW ID:</th>
                ...
                <tr><?php // echo "<pre>"; print_r($bookingdata[0]); 
                    ?>
                    <td rowspan="3" style="text-align: left;padding: 5px;font-size: 12px;vertical-align: top;"><?php echo $bookingdata[0]->firstname;
                                                                                                                echo " ";
                                                                                                                echo $bookingdata[0]->lastname; ?><br>
                        <?php echo $bookingdata[0]->address; ?>
                    </td>
                    ...
                    <td rowspan="3" style="text-align: left;padding: 5px;font-size: 12px;vertical-align: top;border-left: 1px dotted lightgrey;"><?php echo $bookingdata[0]->firstname;
                                                                                                                                                    echo " ";
                                                                                                                                                    echo $bookingdata[0]->lastname; ?><br>
                        <?php echo $bookingdata[0]->address; ?>
                    </td>
                ...
                <tr>
                    ...
                    <th style="text-align: left;padding: 5px;font-size: 12px;border-left: 1px dotted lightgrey;"></th>       
                    <th style="text-align: left;padding: 5px;font-size: 12px;">PLAN</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;">ARRIVAL</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;" colspan="2">TIME</th>
                </tr>
                <tr>
                    ...
                    <td style="text-align: left;padding: 5px;font-size: 12px;border-left: 1px dotted lightgrey;"></td>       
                    <td style="text-align: left;padding: 5px;font-size: 12px;">---</td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"><?php echo date('d-m-Y', strtotime($bookingdata[0]->checkindate)) ?></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;" colspan="2"><?php echo date('h:i:s A', strtotime($bookingdata[0]->checkindate)); ?></td>
                </tr>
                <tr>
                    <th style="text-align: left;padding: 5px;font-size: 12px;">Cust. GST NO.</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;">GR NO.</th>       
                    <th style="text-align: left;padding: 5px;font-size: 12px;">PAGE</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;">DEPARTURE</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;">TIME</th>

                    <th style="text-align: left;padding: 5px;font-size: 12px;border-left: 1px dotted lightgrey;">Cust. GST NO.</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;">GR NO.</th>       
                    <th style="text-align: left;padding: 5px;font-size: 12px;">PAGE</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;">DEPARTURE</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;">TIME</th>
                ...
                <tr>
                    ...
                    <td style="text-align: left;padding: 5px;font-size: 12px;">-</td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"><?php echo date('d-m-Y', strtotime($bookingdata[0]->checkoutdate)) ?></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"><?php echo date('h:i:s A', strtotime($bookingdata[0]->checkoutdate)); ?></td>
                ...
                <tr> 
                    <td colspan="5" style="border: none;border-bottom: 1px solid black;border-top: 1px solid black;">
                        <div style="padding :5px;"></div>
                    </td>
                    <td colspan="5" style="border: none;border-bottom: 1px solid black;border-top: 1px solid black;border-left: 1px dotted lightgrey;">
                        <div style="padding :5px;"></div>
                    </td>
                </tr>
                <tr> 
                    <td colspan="5" style="border: none;border-bottom: 1px solid black;padding: 5px;font-size: 12px;">
                        <b>Bill No.</b>
                    </td>
                    <td colspan="5" style="border: none;border-bottom: 1px solid black;padding: 5px;font-size: 12px;border-left: 1px dotted lightgrey;">
                        <b>Bill No.</b>
                    </td>
                </tr>
                <tr>
                    <th style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;">DATE</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;">ROOM NO.</th>       
                    <th style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;">ROOM TYPE</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;">CREDIT</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;">AMOUNT</th>

                    <th style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;border-left: 1px dotted lightgrey;">DATE</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;">ROOM NO.</th>       
                    <th style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;">ROOM TYPE</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;">CREDIT</th>
                    <th style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;">AMOUNT</th>
                ...
                <?php
                    ...
                    $roomrate = explode(",", $bookingdata[$inl]->roomrate);
                    $gstamt = explode(",", $bookingdata[$inl]->gstamt);
                    $extrabed    = explode(",", $bookingdata[$inl]->extrabed);
                    $extraperson    = explode(",", $bookingdata[$inl]->extraperson);
                    $extrachild    = explode(",", $bookingdata[$inl]->extrachild);

                    $inrrent = explode(",", $bookingdata[$inl]->roomrate);
                    $offer = explode(",", $bookingdata[$inl]->offer_discount);
                    $typeid = explode(",", $bookingdata[$inl]->roomid);
                    for ($inr = 0; $inr < count($rno); $inr++) {
                        $roomtype = $this->db->select("roomtype,bedcharge, personcharge")->from("roomdetails")->where("roomid", $typeid[$inr])->get()->row();
                ...
                <tr>
                    <td style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;"><?php echo date('d/m/Y', strtotime($bookingdata[$inl]->checkindate)); ?></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;"><?php echo html_escape($rno[$inr]); ?></td>       
                    <td style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;"><?php echo $roomtype->roomtype; ?></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;">CREDIT</td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;"><?php echo html_escape($roomrate[$inr]); ?></td>

                    <td style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;border-left: 1px dotted lightgrey;"><?php echo date('d/m/Y', strtotime($bookingdata[$inl]->checkindate)); ?></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;"><?php echo html_escape($rno[$inr]); ?></td>       
                    <td style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;"><?php echo $roomtype->roomtype; ?></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;">CREDIT</td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;"><?php echo html_escape($roomrate[$inr]); ?></td>
                ...
                ?>
                <tr>
                    <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px; margin-top: 10px;"></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"></td>
                    <td style="text-align: left;padding: 5px; font-size: 12px; ">NetAmt</td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"><?php echo $total_price - $total_gstamt + $discountamount; ?></td>

                    <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px; margin-top: 10px;border-left: 1px dotted lightgrey;"></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"></td>
                    <td style="text-align: left;padding: 5px; font-size: 12px; ">NetAmt</td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"><?php echo $total_price - $total_gstamt + $discountamount; ?></td>
                ...
                <tr>
                    <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;">Room Total SGST</td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"><?php echo round($total_gstamt / 2, 2); ?></td>

                    <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;border-left: 1px dotted lightgrey;"></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;">Room Total SGST</td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"><?php echo round($total_gstamt / 2, 2); ?></td>
                ...
                <tr>
                    <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;">Ex.Bed/Per./Ch.Amt.</td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"><?php echo html_escape($allbpccharge); ?></td>
                ...
                <tr>
                    ...
                    <td style="text-align: left;padding: 5px;font-size: 12px;"></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;">Total Amount</td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"><?php echo $nettot = $total_price - $discountamount + $allbpccharge; ?></td>
            ...
            <tfoot style="position: fixed;bottom: 0;">  
                <tr> 
                    <td colspan="5" style="border: none;border-top: 1px solid black;padding: 5px;font-size: 10px;">
                        I agree that my liability for this bill is not waived and agree to be held personally liable in the event that indicates person/
                        company/ association fails to pay any part of the amount of these charges. I also agree that all the charges contained in
                        this account are correct.
                    </td>
                    <td colspan="5" style="border: none;border-top: 1px solid black;padding: 5px;font-size: 10px;border-left: 1px dotted lightgrey;">
                        I agree that my liability for this bill is not waived and agree to be held personally liable in the event that indicates person/
                        company/ association fails to pay any part of the amount of these charges. I also agree that all the charges contained in
                        this account are correct.
                    </td>
                ...
                <tr> 
                    <td colspan="5" style="border: none;padding: 5px;font-size: 12px;text-align: right;">
                        Please collect receipt when paying by cash..     
                    </td>
                    <td colspan="5" style="border: none;padding: 5px;font-size: 12px;text-align: right;border-left: 1px dotted lightgrey;">
                        Please collect receipt when paying by cash..     
                    </td>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: center;padding: 5px;font-size: 12px;"><br/><br/>Bank Name</th>
                    <th style="text-align: center;padding: 5px;font-size: 12px;"><br/><br/>Branch Name</th> 
                    <th style="text-align: center;padding: 5px;font-size: 12px;"><br/><br/>Account No.</th>
                    <th style="text-align: center;padding: 5px;font-size: 12px;"><br/><br/>IFSC Code</th>

                    <th colspan="2" style="text-align: center;padding: 5px;font-size: 12px;border-left: 1px dotted lightgrey;"><br/><br/>Bank Name</th>
                    <th style="text-align: center;padding: 5px;font-size: 12px;"><br/><br/>Branch Name</th> 
                    <th style="text-align: center;padding: 5px;font-size: 12px;"><br/><br/>Account No.</th>
                    <th style="text-align: center;padding: 5px;font-size: 12px;"><br/><br/>IFSC Code</th>
                </tr> 
                <tr>
                    <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;border-bottom: 1px solid black;"><br/><br/>Receptionist / Cashier</th>
                    <th colspan="2" style="text-align: center;padding: 5px;font-size: 12px;border-bottom: 1px solid black;"><br/><br/>Manager </th> 
                    <td colspan="1" style="text-align: right;padding: 5px;font-size: 12px;border-bottom: 1px solid black;"><br/><br/>Guest Signature</th>

                    <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;border-bottom: 1px solid black;border-left: 1px dotted lightgrey;"><br/><br/>Receptionist / Cashier</th>
                    <th colspan="2" style="text-align: center;padding: 5px;font-size: 12px;border-bottom: 1px solid black;"><br/><br/>Manager </th> 
                    <td colspan="1" style="text-align: right;padding: 5px;font-size: 12px;border-bottom: 1px solid black;"><br/><br/>Guest Signature</th>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;border-bottom: 1px solid black;margin-bottom: 5px!important;">PAN NO:</th>
                    <td colspan="1" style="text-align: left;padding: 5px;font-size: 12px;border-bottom: 1px solid black;">GST NO:</th> 
                    <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;border-bottom: 1px solid black;">SAC:</th>

                    <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;border-bottom: 1px solid black;margin-bottom: 5px!important;border-left: 1px dotted lightgrey;">PAN NO:</th>
                    <td colspan="1" style="text-align: left;padding: 5px;font-size: 12px;border-bottom: 1px solid black;">GST NO:</th> 
                    <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;border-bottom: 1px solid black;">SAC:</th>
...
<div id="printArea" hidden>
    <!--Print button-->
    <div class="invoice-wrap print-content">
        <!-- End print 2 copies vivek -->
        <?php

        $firstdate = $bookingdata[0]->checkindate;
        $lastdate = $bookingdata[0]->checkoutdate;
        ...
        <table class="" style="width:100%;border-collapse: collapse;" cellpadding="0" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="8" style="border: 1px solid black;border-left: none;text-align: left;padding: 5px;">
                        <address>
                            <strong>
                                <h2><?php echo html_escape($setting->title); ?>
                            </strong></h2>
                            <strong>Address :-</strong><?php echo html_escape($setting->address); ?><br>
                            <strong>Contact No :-</strong><?php echo html_escape($setting->phone); ?><br>
                            <strong><?php echo display('email') ?>:-</strong>
                ...
                <tr>
                    <td colspan="5">
                        <table>
                            <tr>
                                <th colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">NAME & ADDRESS</th>
                                <th colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">ROOM NO.</th>
                                <th colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">TYPE:</th>
                                <th colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">GUEST:</th>
                                <th colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">GROUP/CREW ID:</th>
                            ...
                            <tr><?php // echo "<pre>"; print_r($bookingdata[0]); 
                                ?>
                                <td rowspan="3" colspan="2" style="text-align: left;padding: 5px;font-size: 12px;vertical-align: top;"><?php echo $bookingdata[0]->firstname;
                                                                                                                                        echo " ";
                                                                                                                                        echo $bookingdata[0]->lastname; ?><br>
                                    <?php echo $bookingdata[0]->address; ?>
                                </td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"><?php echo $bookingdata[0]->room_no; ?></td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"><?php echo $bookingdata[0]->roomtype; ?></td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"><?php echo $bookingdata[0]->nuofpeople; ?></td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"><input type="text" name="crew" style="width: 100%;"></td>
                            ...
                            <tr>
                                ...
                                <th style="text-align: left;padding: 5px;font-size: 12px;">PLAN</th>
                                <th style="text-align: left;padding: 5px;font-size: 12px;">ARRIVAL</th>
                                <th style="text-align: left;padding: 5px;font-size: 12px;" colspan="7">TIME</th>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;padding: 5px;font-size: 12px;">---</td>
                                <td style="text-align: left;padding: 5px;font-size: 12px;"><?php echo date('d-m-Y', strtotime($bookingdata[0]->checkindate)) ?></td>
                                <td style="text-align: left;padding: 5px;font-size: 12px;" colspan="7"><?php echo date('h:i:s A', strtotime($bookingdata[0]->checkindate)); ?></td>


                            </tr>
                            <tr>
                                <th colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">Cust. GST NO.</th>
                                <th colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">GR NO.</th>
                                <th colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">PAGE</th>
                                <th colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">DEPARTURE</th>
                                <th colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">TIME</th>
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"><input type="text" name="crew" style="width: 100%;"></td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">-</td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"><?php echo date('d-m-Y', strtotime($bookingdata[0]->checkoutdate)) ?></td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"><?php echo date('h:i:s A', strtotime($bookingdata[0]->checkoutdate)); ?></td>
                    ...
                    <td colspan="5">
                        <table>
                            <tr>
                                <th colspan="2" style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;">DATE</th>
                                <th colspan="2" style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;">ROOM NO.</th>
                                <th colspan="2" style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;">ROOM TYPE</th>
                                <th colspan="2" style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;">CREDIT</th>
                                <th colspan="2" style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;">AMOUNT </th>
                            ...
                            <?php for ($inl = 0; $inl < count($bookingdata); $inl++) { ?>
                                ...
                                ?>
                                    <tr>
                                        <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;"><?php echo date('d/m/Y', strtotime($bookingdata[$inl]->checkindate)); ?></td>
                                        <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;"><?php echo html_escape($rno[$inr]); ?></td>
                                        <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;"><?php echo $roomtype->roomtype; ?></td>
                                        <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;"><?php  if($bookingdata[$inl]->bookingstatus == 5)echo "CREDIT"; else { echo "NA";} ?></td>
                                        <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;"><?php echo html_escape($roomrate[$inr] * $datediff); ?></td>
                            ...
                            <tr>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"></td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">Payment Mode</td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">
                                <?php if($bookingdata[0]->bookingstatus == 5) echo $bookingdata[0]->payment_method; else echo "NA"; ?></td>
                                <td colspan="2" style="text-align: left;padding: 5px; font-size: 12px; ">NetAmt</td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"><?php //echo ($total_price - $total_gstamt + $discountamount) * $datediff; 
                                echo ($total_price + $discountamount) * $datediff;?></td>

                            </tr>
                            <tr>
                                <td colspan="6" style="text-align: left;padding: 5px;font-size: 12px;"></td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">Room Total SGST</td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"><?php echo round($total_gstamt / 2, 2); ?></td>


                            </tr>
                            <tr>
                                <td colspan="6" style="text-align: left;padding: 5px;font-size: 12px;"></td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">Room Total CGST</td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"><?php echo round($total_gstamt / 2, 2); ?></td>
                            ...
                            <tr>
                                <td colspan="6" style="text-align: left;padding: 5px;font-size: 12px;"></td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">Ex.Bed/Per./Ch.Amt.</td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"><?php echo html_escape($allbpccharge); ?></td>


                            </tr>
                            <tr>
                                <td colspan="6" style="text-align: left;padding: 5px;font-size: 12px;"></td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">Total Amount</td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"><?php //echo $nettot = (($total_price - $total_gstamt + $discountamount) * $datediff) + $total_gstamt + $allbpccharge; 
                                echo $nettot = (($total_price + $discountamount) * $datediff) + $allbpccharge;
                                ?></td>

                            </tr>
                            <tr>
                                <td colspan="6" style="text-align: left;padding: 5px;font-size: 12px;"></td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">Discount</td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"><?php echo $discountamount; ?></td>


                            </tr>
                            <tr>
                                <td colspan="6" style="text-align: left;padding: 5px;font-size: 12px;"></td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;">Grand Total</td>
                                <td colspan="2" style="text-align: left;padding: 5px;font-size: 12px;"><?php echo $nettot - $discountamount; ?></td>
                ...
                <tr>
                    <td colspan="5" style="text-align: center;padding: 5px;font-size: 12px;border-bottom: 1px solid black;"><br /><br />Manager </td>
                    <td colspan="5" style="text-align: center;padding: 5px;font-size: 12px;border-bottom: 1px solid black;"><br /><br />Guest Signature</td>


                </tr>
                <tr>
                    <td colspan="3" style="text-align: left;padding: 5px;font-size: 12px;border-bottom: 1px solid black;margin-bottom: 5px!important;">PAN NO:</td>
                    <td colspan="3" style="text-align: left;padding: 5px;font-size: 12px;border-bottom: 1px solid black;">GST NO:</td>
                    <td colspan="4" style="text-align: left;padding: 5px;font-size: 12px;border-bottom: 1px solid black;">SAC:</td>
                </tr>
                <!-- Second Print vivek-->
                <tr>
                    <td colspan="10" style="border: none;border-bottom: 1px solid black;">
                        <div style="padding :5px;"></div>
                    </td>
                </tr>
                <tr>
