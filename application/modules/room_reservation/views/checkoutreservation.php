...
<div class="form-group row">
    ...
    <label class="col-3 col-sm-3 col-md-3 col-lg-2 col-xl-2 col-form-label text-right font-weight-600"><?php echo display("room_no") ?>
        :</label>
        ...
        <div class="SumoSelect" tabindex="0" role="button" aria-expanded="false">
            <select multiple="multiple" class="testselect2 SumoUnder" tabindex="-1" id="chroomno">
                <?php foreach ($checkinrooms as $rooms) { ?>
                    <option value="<?php echo html_escape($rooms->bookedid); ?>" <?php if ($bookingdata[0]->bookedid == $rooms->bookedid) {
                                                                                        echo "Selected";
                                                                                    } ?>>
                                ...
                                <td>
                                    <table class="table table-bordered table-sm mb-0 tr-background">
                                        ...
                                        <tbody>
                                            ...
                                            $gstamt = explode(",", $bookingdata[$l]->gstamt); //kiran
                                            ...
                                            ?>
                                                ...
                                                <?php } */ ?>
                                                        <?php echo $singletax = html_escape($gstamt[$n]); //kiran
                                                        $allsingle += $singletax; //kiran
                                                        ?>
                                                    </td>
                                                    <td>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" style="border: 1px solid black;border-right: none;padding: 5px;">
                            <div><img src="<?php echo base_url(); ?><?php echo html_escape(!empty($invoicelogo->invoice_logo) ? $invoicelogo->invoice_logo : 'assets/img/header-logo.png') ?>" class="img-fluid mb-3" alt=""></div>
                        </td>
                        ...
                        <td colspan="5">
                            <table>
                                ...
                                <tr>
                                    ...
                                    echo ($total_price + $discountamount) * $datediff;
                                    ?></td>
