                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            ...
                            <div class="icon-addon addon-md">
                                <i class=""><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?></i>
                                <input type="number" disabled class="form-control" readonly="true" id="advanceamount"
                                    placeholder="<?php echo display("advance_amount") ?>">
                                <i class=""><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></i>
                            </div>
                        </div>
                    </div>
                </div>
