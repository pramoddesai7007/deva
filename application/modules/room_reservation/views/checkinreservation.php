                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="icon-addon addon-md">
                                            <input type="number" class="form-control form-control" onchange="getgstamt(<?php echo $r; ?>);"
                                                id="rent<?php echo $r; ?>"
                                                value="<?php echo html_escape($roomrate[$r+1]*$totaldays); //echo html_escape($roomrate[$r+1]);?>">
                                        </div>
                                    </div>
                                </td>
                                <td class="border-0">
        ...
        <div class="card flex-fill w-100">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-0" id="tax_charge"><?php echo $total_gstamt; //$taxPercent ?></label>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-0" id="total_charge"><?php echo $totalamount*$totaldays; //echo $totalamount; ?></label>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="icon-addon addon-md">
                                ...
                                <input type="text" disabled class="form-control" id="totalamount"
                                    value="<?php echo $totalamount*$totaldays; //echo $totalamount ?>" placeholder="Total amount">
                                <i
                                    class=""><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></i>
                            </div>
                        </div>
