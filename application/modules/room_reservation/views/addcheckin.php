                                        ...
                                        <tr>
                                            ...
                                            <td class="border-0">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div class="icon-addon addon-md input-left-icon">
                                                        <select class="selectpicker form-select" data-live-search="true"
                                                            data-width="100%" onchange="getgstamt()" id="gst">
                                                            <option value="" selected>Choose
                                            ...
                                            <td class="border-0">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div class="icon-addon addon-md input-left-icon">
                                                        <input type="number" readonly="true" min="0" class="form-control"
                                                            id="gstamt"
                                                            placeholder="<?php echo display("gstamt") ?>" value="0">
                            ...
                            <tr>
                                ...
                                <td class="border-0">
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="icon-addon addon-md">
                                            <input type="number" disabled class="form-control form-control" onchange="getgstamt();" id="rent"
                                                value="0">
                                        </div>
                                    </div>
                                </td>
        ...
        <div class="card flex-fill w-100">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-0" id="bed_amount1"><?php echo "0" ?></label>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-0" id="per_amount2"><?php echo "0" ?></label>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-0" id="child_amount3"><?php echo "0" ?></label>
                        </div>
                    </div>
                    <!-- <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            ...
                            <div class="icon-addon addon-md">
                                <i
                                    class=""><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?></i>
                                <input type="number" disabled class="form-control" readonly="TRUE" id="advanceamount"
