...
function getcapcity() { 
    ...
    var room_type = $("#room_type").find(":selected").val();
    //var complementary_checkboxt = $("#complementary_checkboxt").val()?$("#complementary_checkboxt").val():0;
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(complementary_checkboxt==1){
                ...
                $("#gst").val(obj.gst);  //kiran // uncoment vivek
                $("#gstamt").val(obj.gstamt); //kiran // uncoment vivek
...
function personprice() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $("#per_amount2").text(obj.personrate);
            calculateSum();
        }
    });
}
...
function childprice() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $("#child_amount3").text(obj.childrate);
            calculateSum();
        }
    });
}
...
function newBooking() { 
    ...
    var advanceamount = parseFloat(advanceamount)?parseFloat(advanceamount):0;
    if(advanceamount<500){
        swal({
            title: "Failed",
            text: "Please make advance payment minimum Rs.500",
            type: "error",
            confirmButtonColor: "#28a745",
            confirmButtonText: "Ok",
            closeOnConfirm: true
    ...
    var advanceamount = $("#advanceamount").val();
    var paymentmode_vv = $("#paymentmode_vv").val();
