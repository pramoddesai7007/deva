...
function room(r,s=null){
    ...
    col += '<tr><td colspan="2"><table class="table table-borderless mb-0"><tbody><tr>'
           ...
           +'id="gstamt'+i+'" placeholder="gstamt"><label class="fas fa-tags"></label></div></div></td></tr></tbody></table></td><td rowspan="3" class="text-center"><button type="button" class="btn btn-danger btn-sm rdel'+i+'" onclick="rdel('+i+')"><i class="far fa-trash-alt"></i></button>'
           +'</td></tr>';
