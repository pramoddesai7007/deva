                                    ...
                                    <table width="100%" id="rexdatatable"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if(!empty($book->bookedid)){
                                                        $sql ="SELECT * FROM `tbl_guestpayments` WHERE `bookedid` = $book->bookedid GROUP BY `bookedid` DESC";
                                                ...
                                                <td><?php echo html_escape($book->total_price-$book->total_gstamt);?></td>
                                                <td><?php echo html_escape($book->total_gstamt);?></td>
                                                ...
                                                <td><a href="<?php echo base_url("reports/booking-details/".html_escape($book->bookedid)) ?>"
                                                        ...
                                                        title="Customer Invoice"><i class="ti-receipt"></i></a>
                                                        <?php if($book->bookingstatus==5){ ?>
                                                        <!-- <a onclick="undo_checkout(<?php echo $book->bookedid ?>);" class="btn btn-primary btn-mini" style="font-size: 11px;" id="undocheckout<?php echo $book->bookedid ?>">Undo Checkout</a> -->
                                                        <input type="button" onclick="undo_checkout(<?php echo $book->bookedid ?>);" class="btn btn-primary btn-mini" style="font-size: 11px;width: 83%;" id="undocheckout<?php echo $book->bookedid ?>" value="Undo Checkout" />                                                    <?php } ?>
                                                    </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
