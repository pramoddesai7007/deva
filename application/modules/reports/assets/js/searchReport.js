...
//kiran
//kiran chavan
function undo_checkout(bookingid){
    $("#undocheckout"+bookingid).attr('disabled','disabled');
   var csrf = $('#csrf_token').val();
    var myurl       = baseurl + "room_reservation/room_reservation/undo_checkout";
    $.ajax({
        url: myurl,
        type: "POST",
        data: {
