<div class="sidebar-header">
    <a href="<?php echo base_url('dashboard/home') ?>" class="sidebar-brand">
        <img class="sidebar-brand_icon"
            src="<?php echo html_escape(base_url((!empty($setting->logo)?$setting->logo:'assets/img/sidebar-logo.png'))) ?>"style="width:190px ; height:65px ; margin-top:20px ;  margin-left:3px margin-bottom: 5px;"
            alt="">
    </a>
</div>
<!--/.sidebar header-->
        ...
        <ul class="metismenu">
            ...
            <?php  
                ...
                //group level name
                    ...
                    "room_company_details_list" => array(
                        //menu name
                            "controller" => "room_companidetails",
                            "method"     => "index",
                            "url"        => "room_facilities/room-company-details-list",
                            "permission" => "read"
                        
                    ),
                    "room_gst_details_list" => array(
                        //menu name
                            "controller" => "room_gstidetails",
                            "method"     => "index",
                            "url"        => "room_facilities/room-gst-details-list",
                            "permission" => "read"
                ...
                //group level name
                    ...
                    "advance_booking_list" => array(
                        //menu name
                            "controller" => "room_reservation",
                            "method"     => "index",
                            "url"        => "room_reservation/booking-list/1",
                            "permission" => "read"
                    ...
                    "checkoutlist" => array(
                        //menu name vivek
                            "controller" => "room_reservation",
                            "method"     => "checkoutlist",
                            "url"        => "room_reservation/allcheckout-list",
                            "permission" => "read"
