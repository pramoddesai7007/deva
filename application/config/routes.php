...
$route['reports/guest-report'] = "reports/report/guest_report"; //kiran
...
//company_master
$route['room_facilities/room-company-details-list'] = "room_facilities/room_companidetails/index";
$route['room_facilities/room-company-details-delete/(:num)'] = "room_facilities/room_companidetails/delete/$1";

//gst_master
$route['room_facilities/room-gst-details-list'] = "room_facilities/room_gstidetails/index";
$route['room_facilities/room-gst-details-delete/(:num)'] = "room_facilities/room_gstidetails/delete/$1";

//Room reservation
//$route['room_reservation/booking-list'] = "room_reservation/room_reservation/index";
$route['room_reservation/booking-list/?(:num)?'] = "room_reservation/room_reservation/index/$1"; //kiran
