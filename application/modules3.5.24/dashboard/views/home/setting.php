    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="gst_no" class="col-sm-3 col-form-label"><?php echo display('gst_no') ?></label>
                    <div class="col-sm-6">
                        <input name="gst_no" type="text" class="form-control" id="gst_no"
                            placeholder="<?php echo display('gst_no') ?>"
                            value="<?php echo html_escape($setting->gst_no) ?>">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="pan_no" class="col-sm-3 col-form-label"><?php echo display('pan_no') ?></label>
                    <div class="col-sm-6">
                        <input name="pan_no" type="text" class="form-control" id="pan_no"
                            placeholder="<?php echo display('pan_no') ?>"
                            value="<?php echo html_escape($setting->pan_no) ?>">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="sac" class="col-sm-3 col-form-label"><?php echo display('sac') ?></label>
                    <div class="col-sm-6">
                        <input name="sac" type="text" class="form-control" id="sac"
                            placeholder="<?php echo display('sac') ?>"
                            value="<?php echo html_escape($setting->sac) ?>">
                    </div>
                </div>
                ...
                <div class="form-group row" >
                    <label for="footer_text"
                        class="col-sm-3 col-form-label">Booking Type</label>
                    <div class="col-sm-6">
                        <select class="form-control basic-single" id="booking_type" name="booking_type" onchange="check_book_type();" >
                            <option value="1" <?php if($setting->booking_type=="1"){ echo display('selected');}?> >24 hrs booking</option>
                            <option value="0" <?php if($setting->booking_type=="0"){ echo display('selected');}?>>Checkout time booking</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row hide_book_type" style="display:none!important;" hidden>
                    <label for="checkin" class="col-sm-3 col-form-label">hhh<?php echo display('checkin_time'); ?></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group row hide_book_type">
                    <label for="storevat"
