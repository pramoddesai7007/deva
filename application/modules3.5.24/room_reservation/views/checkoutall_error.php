...
<div class="d-lg-flex align-items-center justify-content-between">
    ...
    <div class="mt-3 mt-lg-0"> <!-- class="print-btn" -->
        <button type="button" id="print_invoice" onclick="printDiv();"
            class="btn btn-success btn-lg"><?php echo display("print") ?></button>
        ...
        <table class="" style="width:100%;border-collapse: collapse;" cellpadding="0" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: left;padding: 5px;font-size: 12px;font-size: 12px;"><?php echo $inrrent[$inr]; ?></td>
                </tr>
                <?php } } ?>
                <?php for($r=1;$r<=15;$r++){ ?>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: left;padding: 5px;font-size: 12px;"></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"><?php echo $allroomrent = $total_price-$total_gstamt+$discountamount; ?></td>
                </tr>
                <tr>
                    <td colspan="5" style="text-align: left;padding: 5px;font-size: 12px;"></td>
                ...
                <tr>
                    <td colspan="5" style="text-align: left;padding: 5px;font-size: 12px;"></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;">Service Charge</td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"><?php echo $scharge = ($allroomrent*$setting->servicecharge)/100; ?></td>
                </tr>
                <tr>
                    <td colspan="5" style="text-align: left;padding: 5px;font-size: 12px;"></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;">Total Amount</td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"></td>
                    <td style="text-align: left;padding: 5px;font-size: 12px;"><?php echo $nettot = $total_price+$discountamount+$scharge; //+$total_gstamt?></td>
                </tr>
                <tr>
                    <td colspan="5" style="text-align: left;padding: 5px;font-size: 12px;"></td>
            ...
            <tfoot style="">  <?php //position: fixed;bottom: 0; ?>
                <tr> 
